...
{
    public class WebAPITests : IClassFixture<TestFixture<Startup>>
    {
        private HttpClient Client;

        public WebAPITests(TestFixture<Startup> fixture)
        {
        ...
        {
            // Arrange
            var request = "/api/v1/WebAPI/StockItem";
        ...
        {
            // Arrange
            var request = "/api/v1/WebAPI/StockItem/1";
